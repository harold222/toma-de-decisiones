...
@Component({
  selector: 'app-criterio-cuatro',
  templateUrl: './criterio-cuatro.component.html',
  styleUrls: ['./criterio-cuatro.component.css']
})
export class CriterioCuatroComponent implements OnInit {
